...
abstract public class CardDesign 
{
    ...
    @JsonProperty(required = false)
    @JsonPropertyDescription("The delta-X value of the art positioning on this card. Defaults to default to " + DEFAULT_ART_X)
    public final double artX;

    @JsonProperty(required = false)
    @JsonPropertyDescription("The delta-Y value of the art positioning on this card. Defaults to default to " + DEFAULT_ART_Y)
    public final double artY;
}